  ...
  return (
    <div className="overflow-hidden flex justify-center flex-col items-center">
      ...
      <div className='flex flex-row w-full justify-center gap-6 mb-8'>
        ...
        <div className='btn2 rounded-full flex justify-around items-center w-[75px] h-[75px] bg-white border-2 border-[#341931]'><FaHeart className='w-8 h-8 border-[#341931]' /></div>
        <div className='btn3 rounded-full flex justify-around items-center w-[75px] h-[75px] bg-[#FF1168] border-2 border-none'><BsMusicNote className='w-8 h-8 text-white' /></div>
      </div>
